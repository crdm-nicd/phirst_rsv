...
forval j = 1/`=_N' {
quietly replace rsvautp=1 if rsvautp==2 & (rsvautp[_n-1]==1 | rsvautp[_n+1]==1) 
quietly replace rsvbutp=1 if rsvbutp==2 & (rsvbutp[_n-1]==1 | rsvbutp[_n+1]==1)
*display "Run: " `j'
}
...
forval j = 1/`=_N' {
*
quietly replace frsva=1 if rsvaal[_n]==1 & rsvaal[_n-1]>1 & rsvaal[_n-2]>1 
quietly replace lrsva=1 if rsvaal[_n]==1 & rsvaal[_n+1]>1 & rsvaal[_n+2]>1 
*
quietly replace frsvb=1 if rsvbal[_n]==1 & rsvbal[_n-1]>1 & rsvbal[_n-2]>1 
quietly replace lrsvb=1 if rsvbal[_n]==1 & rsvbal[_n+1]>1 & rsvbal[_n+2]>1 
*
quietly replace frsvutp=1 if rsvutp[_n]==1 & rsvutp[_n-1]>1 & rsvutp[_n-2]>1 
quietly replace lrsvutp=1 if rsvutp[_n]==1 & rsvutp[_n+1]>1 & rsvutp[_n+2]>1 
*
}
*
...
forval k = 1/`=_N' {
*
quietly replace ersva=ersva[_n-1] if rsvaal[_n]==1 & rsvaal[_n-1]>0  & frsva==.
quietly replace ersva=ersva[_n-1] if rsvaal[_n]>1 & (rsvaal[_n-1]==1) & (rsvaal[_n+1]==1)
*
quietly replace ersvb=ersvb[_n-1] if rsvbal[_n]==1 & rsvbal[_n-1]>0 & frsvb==.
quietly replace ersvb=ersvb[_n-1] if rsvbal[_n]>1 & (rsvbal[_n-1]==1) & (rsvbal[_n+1]==1)
*
quietly replace ersvutp=ersvutp[_n-1] if rsvutp[_n]==1 & rsvutp[_n-1]>0 & frsvutp==.
quietly replace ersvutp=ersvutp[_n-1] if rsvutp[_n]>1 & (rsvutp[_n-1]==1) & (rsvutp[_n+1]==1)
*
}
*
