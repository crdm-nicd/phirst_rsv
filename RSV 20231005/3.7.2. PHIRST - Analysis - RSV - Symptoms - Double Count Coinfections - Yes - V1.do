**************************************************************
**************************************************************
*PHIRST: RSV Symptoms - Analysis - Double Count Co-Infections*
**************************************************************
**************************************************************
...
*RSV A*
keep if ersvafn!=.
collapse (max) fever cough sorethroat muscleache diarrhoea runnynose diffbreath chestpain vomiting headache coughingfitbreath coughingfitvomiting othersymptom missed outvisit hospitalised, by(year siteid hhid indid ersvafn)
rename ersvafn epis
gen type=1
...
keep if ersvbfn!=.
collapse (max) fever cough sorethroat muscleache diarrhoea runnynose diffbreath chestpain vomiting headache coughingfitbreath coughingfitvomiting othersymptom missed outvisit hospitalised, by(year siteid hhid indid ersvbfn)
rename ersvbfn epis
gen type=2
...
*
save "PHIRST - Data - Epi - 2017-2018 - Symptoms - Double Count Coinfections - Yes.dta", replace
